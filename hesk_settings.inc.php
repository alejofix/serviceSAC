...
// --> General settings
$hesk_settings['site_title']='ServiceDesk SAC';
$hesk_settings['site_url']='http://190.84.51.204/serviceSAC/';
$hesk_settings['webmaster_mail']='oscar.jimenez@claro.com.co';
$hesk_settings['noreply_mail']='oscar.jimenez@claro.com.co';
$hesk_settings['noreply_name']='Help Desk SAC';
...
$hesk_settings['hesk_url']='http://localhost/HelpDesk/Install/install.php';
...
$hesk_settings['secimg_sum']='X792V57E38';
...
$hesk_settings['ticket_list']=array('trackid','lastchange','name','subject','status','lastreplier','custom3');
...
'custom2'=>array('use'=>1,'place'=>0,'type'=>'text','req'=>1,'name'=>'Fuente','maxlen'=>140,'value'=>''),
'custom3'=>array('use'=>1,'place'=>0,'type'=>'checkbox','req'=>1,'name'=>'Impacta a','maxlen'=>140,'value'=>'Call Center SAC#HESK#Call Center  Soporte #HESK#CAVs#HESK#CGO#HESK#CGV#HESK#Web Center#HESK#Ajustes#HESK#Facturación #HESK#Cartera#HESK#PQR#HESK#Mejoramiento #HESK#Service Desk#HESK#Control de Calidad'),
'custom4'=>array('use'=>1,'place'=>0,'type'=>'text','req'=>1,'name'=>'Escalado a','maxlen'=>140,'value'=>''),
'custom5'=>array('use'=>0,'place'=>0,'type'=>'text','req'=>0,'name'=>'Custom field 5','maxlen'=>255,'value'=>''),
'custom6'=>array('use'=>1,'place'=>0,'type'=>'text','req'=>1,'name'=>'Cuentas','maxlen'=>10,'value'=>''),
